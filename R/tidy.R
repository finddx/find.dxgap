...
tidy_tb_dashboard <- function(data, type = c("time_series", "fixed")) {
  ...
  data_select_cols <- data_sliced |>
    dplyr::select(
      ...
      labs_performing_culutre_tests_liquid_2015 = ...77,
      labs_performing_culutre_tests_liquid_2016 = ...78,
      labs_performing_culutre_tests_liquid_2017 = ...79,
      labs_performing_culutre_tests_liquid_2018 = ...80,
      labs_performing_culutre_tests_liquid_2019 = ...81,
      labs_performing_culutre_tests_liquid_2020 = ...82,
