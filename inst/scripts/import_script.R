...
lst_df <- import_tbl(lst_df, "wb_2023-08-31_pop_density.csv", 2019)
lst_df <- import_tbl(lst_df, "wb_2023-08-31_pop_total.csv", 2019)
lst_df <- import_tbl(lst_df, "wb_2023-09-07_gdp.csv", 2019)
lst_df <- import_tbl(lst_df, "who_2023-07-28_budget.csv", 2019)
lst_df <- import_tbl(lst_df, "who_2023-07-28_community.csv", 2019)
lst_df <- import_tbl(lst_df, "who_2023-07-28_estimates.csv", 2019)
