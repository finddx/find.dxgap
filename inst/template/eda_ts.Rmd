...
```{r}
tbl <-
  prep_tb_data(data_tbl, e_inc_num, c_newinc, "country") |> 
...
corr_df_1 <- compute_correlation(tbl, who_dx_gap, by = "year")
```


```{r}
corr_df <- compute_correlation(tbl, who_dx_gap, by = c("is_hbc", "year"))
```
