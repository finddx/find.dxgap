...
---
    ...
    Code
      writeLines(dplyr::pull(dplyr::filter(tibble::as_tibble(dm::dm_examine_constraints(
        dm)), problem != ""), problem))
    Output
      values of `non_hbc$country_code` not in `wb_tot_pop$country_code`: AIA (1), COK (1), MSR (1), NIU (1), TKL (1), WLF (1)
      values of `non_hbc$country_code` not in `wb_urb_pop$country_code`: AIA (1), COK (1), MSR (1), NIU (1), TKL (1), WLF (1)
      values of `non_hbc$country_code` not in `wb_density_pop$country_code`: AIA (1), COK (1), MSR (1), NIU (1), TKL (1), WLF (1)
      values of `non_hbc$country_code` not in `wb_gdp$country_code`: AIA (1), COK (1), MSR (1), NIU (1), TKL (1), WLF (1)
      values of `non_hbc$country_code` not in `who_notifications$country_code`: FRO (1), GIB (1), IMN (1), LIE (1), MAF (1), VIR (1)
      values of `non_hbc$country_code` not in `who_estimates$country_code`: FRO (1), GIB (1), IMN (1), LIE (1), MAF (1), VIR (1)
