test_that("World Bank gdp data is downloaded correctly", {
  skip_on_ci()
  skip_if_not_installed("curl")
  skip_if_offline()
  skip_if_not_available("https://api.worldbank.org/v2/country/all/.indicator")
  path <- download_wb_impl(.indicator = "NY.GDP.MKTP.CD", .range_years = "2021:2022")
...
test_that("World Bank gdp data is read and tidied correctly", {
  ...
  path <- file.path(Sys.getenv("DXGAP_DATADIR"), "wb_2023-09-07_gdp.csv")
