...
When is [#289](https://github.com/finddx/find.dxgap/pull/289) is merged, tables from different providers will all be accessible with a unique function. For instance:
